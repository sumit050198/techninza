    ...
    line-height: 36px;
			...
			<div role="main" class="main">
                ...
                <section class="page-header">
                        ...
                        <div class="row">
                           <img class="banner-img-service" src="img/Machine_learning.png">
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-7 mb-5 mb-md-0">
                                ...
                                <div class="overflow-hidden mb-4">
                                    <h2 class="text-color-dark font-weight-bold text-8 line-height-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="800">Machine Learning</h2>
                                </div>
                                <p class="custom-text-size-1 pt-3 pb-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">AI (ML) is the investigation of Computer calculations that improve consequently through understanding. It is viewed as a subset of man-made reasoning. AI calculations manufacture a numerical model dependent on test information, known as "preparing information", so as to settle on expectations or choices without being unequivocally customized to do as such.

</p>
                                <p class="custom-text-size-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">
Techninza was established on the conviction that AI and man-made reasoning are groundbreaking advancements that will make the following quantum gain in client experience and unit financial matters of organizations. Quantiphi assists customers with finding and catch concealed an incentive from information through an interesting mix of business astuteness, huge information, AI.
</p>
