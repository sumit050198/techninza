								...
								<div class="row">
									<div class="col-md-12 align-self-center p-static order-2 text-center">
										<div class="overflow-hidden pb-2">
											<h1 class="text-dark font-weight-bold text-9 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="100">Talkcharge</h2>
										</div>
									</div>
				...
				<div class="container py-4">
							...
							<div class="owl-carousel owl-theme nav-inside nav-inside-edge nav-squared nav-with-transparency nav-dark nav-lg d-block overflow-hidden" data-plugin-options="{'items': 1, 'margin': 10, 'loop': false, 'nav': true, 'dots': false, 'autoHeight': true}" style="height: 510px;">
								<div>
									<div class="img-thumbnail border-0 border-radius-0 p-0 d-block">
										<img src="img/logos/talkcharge.png" class="img-fluid border-radius-0" alt="">
									</div>
								</div>
								<div>
								<!--	<div class="img-thumbnail border-0 border-radius-0 p-0 d-block">-->
					...
					<div class="row pt-4 mt-2 mb-5">
						<div class="col-md-7 mb-4 mb-md-0">
							...
							<p>Talkcharge is an affiliate marketing company , which gives cashback on every shopping done through it</p>

							<p>It also contains options for Recharge, Bill payment and other options, you can also buy giftcard from there.</p>
						...
						<div class="col-md-5">
							...
							<ul class="list list-icons list-primary list-borders text-2">
								<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Client:</strong> Talkcharge</li>
								...
								<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Project URL:</strong> <a href="https://www.talkcharge.com" target="_blank" class="text-dark">www.talkcharge.com</a></li>
							</ul>
						</div>
					</div>
