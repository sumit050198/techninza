			...
			<div role="main" class="main">
                ...
                <section>
                        ...
                        <div class="col-12 py-4">
                                <h2 class="text-color-dark text-center font-weight-bold text-8 line-height-2 mb-2 mb-md-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">Brand We Have Served For</h2>
                                </div>
                             <div class="row">
                   ...
                   <div class="owl-carousel owl-theme p-3">
                            ...
                            <div class="item">       
                             <a href="/img/gallery/crm5.png" class="fancybox fancybox-gallery" data-fancybox="gallery1">
                                <img src="/img/gallery/crm55.png" alt="">
                            </a>
                            </div>
                            <!-- card4+2-->
                            <div class="item">       
