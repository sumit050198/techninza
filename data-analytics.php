    ...
    line-height: 36px;
			...
			<div role="main" class="main">
                ...
                <section class="page-header">
                        ...
                        <div class="row">
                           <img class="banner-img-service" src="img/Data_Analytics.png">
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-7 mb-5 mb-md-0">
                                ...
                                <div class="overflow-hidden mb-4">
                                    <h2 class="text-color-dark font-weight-bold text-8 line-height-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="800">Data Analytics</h2>
                                </div>
                                <p class="custom-text-size-1 pt-3 pb-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">Data Analysis is a cycle of investigating, purifying, changing and demonstrating information with the objective of finding valuable data, illuminating ends and supporting dynamic. Information examination has numerous features and approaches, including various procedures under an assortment of names, and is utilized in various business, science, and sociology areas. In the present business world, information examination assumes a job in settling on choices more logical and helping organizations work all the more successfully.

</p>
                                <p class="custom-text-size-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">
Investigation alludes to breaking an entire into its different segments for singular assessment. Information investigation is a cycle for acquiring crude information and changing over it into data helpful for dynamic by clients. Information is gathered and examined to respond to questions, test speculations or invalidate hypotheses.
</p>
