                    ...
                    <div class="container container-lg py-5">
                        <div class="row">
                            <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                                <h1 class="font-weight-extra-bold text-14 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">Content Writing</h1>
                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-7 mb-5 mb-md-0">
                                ...
                                <div class="overflow-hidden mb-4">
                                    <h2 class="text-color-dark font-weight-bold text-8 line-height-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="800">Content Writing</h2>
                                </div>
                                <p class="custom-text-size-1 pt-3 pb-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">Techninza comes to you as a one-stop solution for all your content writing needs. We receive the right methodology in creating the content thereby attracting a wide variety of audience. We employ the best talent and creativity to leverage your business. Our expertise across channels, in-depth analysis techniques, and self-innovated technologies help us ensure that consumers meet your brand exactly when they are looking for it. It is a good idea to choose us for all your digital marketing needs as we customer satisfaction is our utmost priority.</p>
