								...
								<div class="row">
									<div class="col-md-12 align-self-center p-static order-2 text-center">
										<div class="overflow-hidden pb-2">
											<h1 class="text-dark font-weight-bold text-9 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="100">Ornaz</h2>
										</div>
									</div>
				...
				<div class="container py-4">
							...
							<div class="owl-carousel owl-theme nav-inside nav-inside-edge nav-squared nav-with-transparency nav-dark nav-lg d-block overflow-hidden" data-plugin-options="{'items': 1, 'margin': 10, 'loop': false, 'nav': true, 'dots': false, 'autoHeight': true}" style="height: 510px;">
								<div>
									<div class="img-thumbnail border-0 border-radius-0 p-0 d-block">
										<img src="img/logos/ornaz.png" class="img-fluid border-radius-0" alt="">
									</div>
								</div>
								<div>
								<!--	<div class="img-thumbnail border-0 border-radius-0 p-0 d-block">-->
					...
					<div class="row pt-4 mt-2 mb-5">
						<div class="col-md-7 mb-4 mb-md-0">
							...
							<p>An Online E-commerce website for purchasing Gold, Diamond and other Jewellery.</p>

							<p>Ornaz is one of the best online jewellery selling product, they sell at affordable prices, and they have a lot variety also.</p>
						...
						<div class="col-md-5">
							...
							<ul class="list list-icons list-primary list-borders text-2">
								<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Client:</strong> Ornaz</li>
								...
								<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Project URL:</strong> <a href="https://www.ornaz.com" target="_blank" class="text-dark">www.ornaz.com</a></li>
							</ul>
						</div>
					</div>
