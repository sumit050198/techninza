    ...
    line-height: 36px;
			...
			<div role="main" class="main">
                ...
                <section class="page-header">
                        ...
                        <div class="row">
                           <img class="banner-img-service" src="img/Augmented_Reality.png">
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-7 mb-5 mb-md-0">
                                ...
                                <div class="overflow-hidden mb-4">
                                    <h2 class="text-color-dark font-weight-bold text-8 line-height-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="800">Augmented Reality</h2>
                                </div>
                                <p class="custom-text-size-1 pt-3 pb-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">Augmented reality (AR) is an intelligent encounter of a genuine domain where the items that dwell in reality are upgraded by PC produced perceptual data, here and there over numerous tactile modalities, including visual, hear-able, haptic, somatosensory and olfactory. AR can be characterized as a framework that satisfies three fundamental highlights: a mix of genuine and virtual universes, continuous collaboration, and exact 3D enrollment of virtual and genuine objects.

</p>
                                <p class="custom-text-size-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">
Techninza empowers any business or industry to make their own in-house Augmented and Mixed Reality applications. By making AR and VR affordable and adaptable for business, Techninza’s groundbreaking human-focused platforms engage anybody to just imbue their industry knowledge into customized AR and MR solutions.
</p>
