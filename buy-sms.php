...
tr:nth-child(even) {
                    ...
                    <div class="container container-lg py-5">
                        <div class="row">
                            <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                                <h1 class="font-weight-extra-bold text-14 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">SMS</h1>
                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-7 mb-5 mb-md-0">
                                ...
                                <div class="overflow-hidden mb-4">
                                    <h2 class="text-color-dark font-weight-bold text-8 line-height-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="800">Buy SMS</h2>
                                </div>
                                <p class="custom-text-size-1 pt-3 pb-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">Looking for Bulk SMS Services in India, You are in the right place, Choose from our below plan or for custom rates whatsapp us <a href="https://api.whatsapp.com/send?phone=8375910558">@8375910558</a></p>
  ...
  <tr>
    ...
    <tr>
    <td>1000K Messages</td>
    <td>Rs 105000</td>
    <td>10.5 Paisa</td>
  </tr>
</table>

<p><br/>&nbsp;&nbsp;&nbsp;&nbsp;* 18% Gst Applicable</p>
                    ...
                    <div class="container container-lg">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-lg-8 col-xl-6 mb-5 mb-lg-0">
                                ...
                                <h2 class="text-color-light font-weight-extra-bold text-10 negative-ls-1 pr-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">For Bulk SMS OR Custom Price Connect with US</h2>
                            ...
                            <div class="col-lg-4 col-xl-3">
                                <div class="overflow-hidden">
                                    <a href="contact-us.php" class="btn btn-secondary btn-outline text-color-light font-weight-semibold border-width-4 custom-link-effect-1 text-1 text-xl-3 d-inline-flex align-items-center px-4 py-3 appear-animation" data-appear-animation="maskRight" data-appear-animation-delay="900">GET IN TOUCH NOW <i class="custom-arrow-icon ml-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
